...
const ProductDateCards = ({ selectedEnd2, selectedStart2, selectedEnd, selectedStart, selectedProduct1, applyClicked }) => {
    ...
    useEffect(() => {
        ...
        if (selectedProduct1 && selectedStart && selectedEnd && selectedEnd2 && selectedStart2 ) {
            fetchData();
        }
        ...
        <div className='ProductCards2Container'>
            <div className='Card'>
                ...
                <div className='barsprog'>
                    ...
                    <div className='FirstProgress'>
                        <div className='ProgressTitle'>Period 2</div>
                        <div className='progressBar'>
